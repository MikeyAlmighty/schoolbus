...
export const OtherExamples = () => {
  ...
  const toggleModal = modalNumber =>
    setCurrentOpenModal(currentModal === modalNumber ? null : modalNumber)
  ...
  return (
    <Flex flexDirection="column">
      <Button m="1em" onClick={() => toggleModal(1)}>
      ...
      <Button m="1em" onClick={() => toggleModal(2)}>
        Modal with subtitle
      </Button>
      <Modal
      ...
      <Button m="1em" onClick={() => toggleModal(3)}>
        Modal with proximusTitle
      </Button>
      <Modal {...createDefaultProps(3)} proximusTitle="This is the proximus title" />

      <Button m="1em" onClick={() => toggleModal(4)}>
        Modal with footer
      </Button>
      <Modal
      ...
      <Button m="1em" onClick={() => toggleModal(5)}>
        Modal with centerTitle
      </Button>
      <Modal {...createDefaultProps(5)} centerTitle />
    </Flex>
  )
}
